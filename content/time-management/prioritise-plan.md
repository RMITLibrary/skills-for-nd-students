	...
	<div class="accordion" id="accordionExample">
		...
		<div class="accordion-item">
			...
			<div class="accordion-body">
				<!-- START todoist -->
				<p><strong>Why it helps:</strong><br>
				Todoist is great for decision-making fatigue because it tells you what to focus on <em>now</em>, rather than everything you <em>could</em> do.
				</p>
				<p><strong>Best for:</strong></p>
				<ul>
		...
		<div class="accordion-item">
			...
			<div class="accordion-body">
				<!-- START sticky notes -->
				<p><strong>Why they help:</strong><br>
				Physical sticky notes reduce “out of sight, out of mind” issues and can make tasks feel more real, immediate, and achievable. They can be useful for all people but especially useful for people with ADHD who can benefit a lot from visual reminders.
				</p>
				<p><strong>Best for:</strong></p>
				<ul>
				<li>Tasks you keep forgetting</li>
				<li>Short‑term priorities</li>
				<li>When digital tools feel overwhelming (though if you like digital tools as well, sticky notes can help remind you to check your digital tools)</li>
				</ul>
		...
		<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour">
			...
			<ul>
				...
				<li>Todoist → shows what you’re working on this week or today</li>
