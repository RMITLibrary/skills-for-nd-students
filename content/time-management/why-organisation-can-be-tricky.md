...
<div class="content-856px-max">
    ...
    <div class="table-responsive">
        <table class="table-striped min-width-sm">
        <thead>
            <tr>
                <th>Task</th>
                <th>Neurodivergent brain</th>
                <th>Neurotypical brain</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                ...
                <td>All tasks feel equally urgent, or the brain zooms in on one small detail and ignores the big deadline.</td>
                <td>Can more easily sort tasks into “now / later / can wait”.</td>
            </tr>
        </tbody>
        </table>
    </div>
